...
import type { Patient, PatientFormData } from "@/types/shared";
...
export function EditPatientForm({ patient, trigger }: EditPatientFormProps) {
    ...
    if (patient.id) {
      updatePatient.mutate({ 
        ...
        data: {
          ...
          bloodType: formData.bloodType as "A+" | "A-" | "B+" | "B-" | "AB+" | "AB-" | "O+" | "O-" | null | undefined,
        }
      });
    }
  };
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the patient's information below. All fields marked with * are
            required.
          </DialogDescription>
        </DialogHeader>
